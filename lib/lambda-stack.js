...
const AutoScalingGroupName = appConfig[deployEnv].autoScalingGroupName;
const DBClusterName = appConfig[deployEnv].rdsDBClusterName;
...
module.exports = class StepfunctionStack extends Stack {
  constructor(scope, id, props) {
    ...
    statementUpdateASLGroup.addResources(
      `arn:aws:autoscaling:${region}:${accountId}:autoScalingGroup:*:autoScalingGroupName/${ssm.StringParameter.valueForStringParameter(
        this,
